...
:::{NOTE} top="" tip="" round="" box="" 60%=""
**TIP:** An example program which uses the
...
:::{NOTE} tip=""
 Because of differences in silicon implementation; and the
...
:::{NOTE} box="" bggreen=""
:::{HINT} info=""
This specifies any shell prompt running
on the target
:::
...
with the current RX_LO frequency setting. :::{NOTE} box="" bggreen=""
\<wrap
info>This specifies any shell prompt running on the target
:::
...
:::{NOTE} important=""
 This setting effects all ports simultaneously. For
...
:::{NOTE} tip="" round="" box=""
**NOTE: Switching the RF INPUT port:**\
...
:::{NOTE} tip="" round="" box=""
**NOTE: Switching the RF OUTPUT port:**\
